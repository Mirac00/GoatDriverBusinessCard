...
export default function Home() {
  ...
  const jsonLd = {
    ...
    address: {
      ...
      addressLocality: 'Warszawa', // Derived from address.city which is "00-000 Warszawa"
      postalCode: '00-000',
      addressCountry: 'PL',
    },
    geo: {
      '@type': 'GeoCoordinates',
      latitude: 52.2297, // Warsaw coordinates placeholder
      longitude: 21.0122,
    },
      ...
      <section id="about" className="relative min-h-screen flex items-center justify-center px-8 py-24 overflow-hidden">
        ...
        >
          ...
          >
            ...
            <ContentWrapper>
              {siteData.about.content.map((item, idx) => (
                <p
                  key={idx}
